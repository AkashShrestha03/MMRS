        ...
        (t.fn.position = function (e) {
          ...
          return (
            ...
            this.each(function () {
              ...
              "right" === e.my[0]
                ? (C.left -= r)
                : "center" === e.my[0] && (C.left -= r / 2),
                "bottom" === e.my[1]
                  ? (C.top -= h)
                  : "center" === e.my[1] && (C.top -= h / 2),
                (C.left += D[0]),
                (C.top += D[1]),
      ...
      (h.style.cssText = "background-color:rgba(1,1,1,.5)"),
              ...
              ? (s instanceof o
                  ...
                  : c(a, function (e, i) {
                      ...
                      c(i.props, function (t, e) {
                        ...
                        h[n] &&
                          0 > t.inArray(null, h[n].slice(0, 3)) &&
                          ((h[n][3] = 1), i.from && (h._rgba = i.from(h[n])));
                    }),
                this)
              : void 0;
          },
        ...
        c(a, function (i, n) {
          var a = n.props,
            ...
            h = n.from;
          (o.fn[i] = function (i) {
            if ((l && !this[r] && (this[r] = l(this._rgba)), i === e))
              return this[r].slice();
            var s,
              n = t.type(i),
                  ...
                  (this.diff = (function e(i, s) {
                    ...
                    for (n in s)
                      (a = s[n]),
                        i[n] === a ||
                          o[n] ||
                          (!t.fx.step[n] && isNaN(parseFloat(a))) ||
                          (r[n] = a);
                    return r;
                  })(this.start, this.end)),
                  this
  ...
  t.effects.define("blind", "hide", function (e, i) {
    ...
    t.effects.define("bounce", function (e, i) {
      ...
      for (
        ...
        ((s = {})[m] = (v ? "-=" : "+=") + u),
          ...
          (u = l ? 2 * u : u / 2);
      l &&
        (((s = { opacity: 0 })[m] = (v ? "-=" : "+=") + u), a.animate(s, f, g)),
        a.queue(i),
    ...
    t.effects.define("size", function (e, i) {
      ...
      t.effects.createPlaceholder(a),
        ...
        ("box" === d || "both" === d) &&
          (n.from.y !== n.to.y &&
            ((v = t.effects.setTransition(a, l, n.from.y, v)),
            (b = t.effects.setTransition(a, l, n.to.y, b))),
          n.from.x !== n.to.x &&
            ((v = t.effects.setTransition(a, h, n.from.x, v)),
            (b = t.effects.setTransition(a, h, n.to.x, b)))),
        ("content" === d || "both" === d) &&
          n.from.y !== n.to.y &&
          ((v = t.effects.setTransition(a, r, n.from.y, v)),
    ...
    t.extend(v, {
      ...
      parseDate: function (e, i, s) {
        ...
        if (
          ...
          for (m = 1, v = b; !(v <= (o = this._getDaysInMonth(g, m - 1))); )
            m++, (v -= o);
        if (
          ...
          for (x = 0, k = "", this.maxRows = 4; x < K[1]; x++) {
            ...
            for (
              P += T + "</tr></thead><tbody>",
                ...
                M = Math.ceil(
                  ((H = (this._getFirstDayOfMonth(tt, Z) - c + 7) % 7) + S) / 7
                ),
  ...
  var w = (t.ui.intersect = (function () {
    ...
    return function (e, i, s, n) {
      ...
      switch (s) {
        ...
        case "touch":
          return (
            ((a >= c && a <= d) || (l >= c && l <= d) || (a < c && l > d)) &&
            ((o >= h && o <= u) || (r >= h && r <= u) || (o < h && r > u))
          );
        default:
          return !1;
      }
  ...
  (t.ui.ddmanager = {
        ...
        t.each(
          ...
          function () {
            this.options &&
              (!this.options.disabled &&
                this.visible &&
                w(e, this, this.options.tolerance, i) &&
    ...
    t.widget("ui.slider", t.ui.mouse, {
      ...
      values: function (e, i) {
        ...
        for (
          o = 0, s = this.options.values, n = arguments[0];
          o < s.length;
          o += 1
        )
