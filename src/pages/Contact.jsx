...
const Contact = () => {
  return (
    <main>
        ...
        <div class="container">
          <div class="row">
            <div class="tp-portfolio-breadcrumb-content text-center">
              <h2 class="tp-portfolio-breadcrumb-title tp-portfolio-breadcrumb-title-cntct-us">
                Contact Us
              </h2>
            </div>
          </div>
      ...
      <section class="tp-contact-area mb-5 pb-100">
        <div class="container">
          <div class="row">
            <div class="col-xl-12">
              <form
                ...
                method="POST"
                class="tp-contact-inner-page-wrapper"
              >
                <div class="tp-contact-box tp-contact-inner-page-box mb-120">
                  <h3 class="tp-contact-title tp-contact-title-inner-page wow fadeInUp">
                    Send your message
                  </h3>
          ...
          <div class="tp-contact-inner-page-bottom">
            <div class="row">
              <div class="col-lg-4 col-md-6">
                <div
                  class="tp-contact-inner-page-item mb-30 text-center wow fadeInUp"
                  data-wow-delay=".5s"
              ...
              <div class="col-lg-4 col-md-6">
                ...
                >
                  ...
                  <div class="tp-contact-inner-page-content">
                    <h3 class="tp-contact-inner-page-title">Office time</h3>
                    <a href="#">
