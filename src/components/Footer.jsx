      ...
      <div className="tp-footer-top pt-110 pb-55">
        <div className="container">
          <div className="row">
            ...
            <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 mb-30">
              <div
                className="tp-footer-widget footer-cols-2 tp-footer-widget-cutm-pdg-2  transition-3 wow fadeInUp"
                data-wow-delay=".5s"
                data-wow-duration="1s"
              >
            ...
            <div className="col-xl-4 col-lg-3 col-md-6 col-sm-6 mb-50">
              <div
                className="tp-footer-widget footer-cols-4 tp-footer-widget-cutm-pdg transition-3 wow fadeInUp"
                data-wow-delay=".9s"
                data-wow-duration="1s"
              >
                <div className="tp-footer-thumb-wrap">
                  ...
                  <div className="tp-footer-widget-content-input">
                    ...
                    >
                      ...
                      <button type="submit" className="tp-footer-subscribe-btn w-100">
                        Subscribe Now
                      </button>
                    </form>
                  </div>
